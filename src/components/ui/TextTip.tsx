...
export default function TextTip(props: TextTipProps) {
  ...
  return (
    <span className="group cursor-default">
      ...
      <div className="absolute z-50  hidden -translate-y-6 -translate-x-8 scale-50 rounded-md bg-zinc-700 px-2 py-1 text-white transition delay-150 ease-in-out  group-hover:block group-hover:scale-100">
        {tip}
      </div>
      <div
        className={clsx(
